...
@section('page-header')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0"> {{ __('section.title_page') }}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    <li class="breadcrumb-item"><a href="#" class="default-color">{{ __('section.title_page') }}</a>
                    </li>
                    <li class="breadcrumb-item active text-primary">{{ __('Section.List_Grade') }}</li>
                </ol>
            </div>
        </div>
    </div>
                                        ...
                                        <table class="table center-aligned-table mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($grade->Sections as $key => $list_Sections)
                                                    <tr>
                                                        <td>{{ $key + 1 }}</td>
                                                        <td>{{ $list_Sections->My_classs }}</td>
                                                        <td>
                                                            {{ $list_Sections->My_classes->Name }}
                                                        </td>
                                                        <td>
